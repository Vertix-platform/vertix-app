...
export function useMintNftToCollection() {
  ...
  const mintToCollection = useCallback(
    async (
      params: MintNftToCollectionParams
    ): Promise<{
      success: boolean;
      tokenId?: bigint;
      transactionHash?: Hash;
      ...
      try {
        ...
        toast.loading('Minting NFT to collection...', {
          id: 'mint-nft-to-collection',
        });
        ...
        if (error instanceof Error) {
          if (error.message.includes('User rejected')) {
            ...
            error.message.includes('VertixNFT__CollectionMaxSupplyReached')
          ) {
