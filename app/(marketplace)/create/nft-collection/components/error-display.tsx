...
export function ErrorDisplay({ error, onRetry }: ErrorDisplayProps) {
  const isBackendError = error.includes('Backend') || error.includes('500') || error.includes('service')
  const isConnectionError = error.includes('connect') || error.includes('internet')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">Unable to load collections</h3>
