...
export function MintToCollectionForm({
  collections,
}: MintToCollectionFormProps) {
  ...
  const handleInputChange = (
    field: keyof CollectionMintFormData,
  ...
  const selectedCollection = collections.find(
    c => c.collection_id.toString() === formData.collection_id
  );
      ...
      {selectedCollection && (
        <Card className='border'>
          ...
          <CardContent className='-mt-3'>
            <div className='space-y-2'>
              <div>
                <strong>Name:</strong> {selectedCollection.name}
              </div>
              <div>
                <strong>Symbol:</strong> {selectedCollection.symbol}
              </div>
              <div>
              ...
              <div>
                ...
                {selectedCollection.current_supply} /{' '}
                {selectedCollection.max_supply}
              </div>
            </div>
          </CardContent>
        </Card>
