...
export function CreatorCollectionsTable({
  walletAddress,
}: CreatorCollectionsTableProps) {
                    ...
                    <div className='space-y-1'>
                      ...
                      <div className='w-full bg-gray-200 rounded-full h-2'>
                        <div
                          ...
                          style={{
                            width: `${Math.min(supplyProgress.percentage, 100)}%`,
                          }}
                        />
                      </div>
                      {supplyProgress.isFull && (
                  ...
                  <TableCell>
                    <div className='flex items-center'>
                      ...
                      <span className='font-medium'>
                        {collection.totalVolume.toFixed(2)} ETH
                      </span>
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align='end'>
                        ...
                        {!supplyProgress.isFull && (
                          <DropdownMenuItem
                            onClick={() => handleMintToCollection(collection)}
                          >
