...
export function TransactionStatus({
  ...
  const explorerUrl = transactionHash ? getExplorerUrl(transactionHash, chainId) : null
      ...
      {error && (
        <div className="p-4 bg-red-50 border border-red-200 rounded-lg dark:bg-red-950 dark:border-red-800">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-red-800 dark:text-red-200">Transaction Error</span>
          </div>
